@echo off
REM ===============================================================================
REM WhisperJAV v1.7.4 Installer Build Script
REM ===============================================================================
REM
REM This script builds the conda-constructor installer for WhisperJAV v1.7.4
REM
REM Prerequisites:
REM - Conda with constructor package installed:
REM   conda install constructor -c conda-forge
REM - All v1.7.4 installer files must be present in installer/ directory
REM
REM Build Process:
REM 1. Check prerequisites (constructor, Python)
REM 2. Validate installer configuration (via validate_installer_v1.7.4.py)
REM 3. Clean previous v1.7.4 builds
REM 4. Run constructor to build installer
REM 5. Verify output and generate build report
REM
REM Output: WhisperJAV-1.7.4-Windows-x86_64.exe
REM Logs: build_log_v1.7.4.txt
REM

SETLOCAL EnableDelayedExpansion

REM ===== Configuration =====
set CONFIG_FILE=construct_v1.7.4.yaml
set VALIDATOR=validate_installer_v1.7.4.py
set BUILD_LOG=build_log_v1.7.4.txt
set VERSION=1.7.4

echo ===============================================================================
echo                    WhisperJAV v1.7.4 Installer Build
echo ===============================================================================
echo.

REM Initialize log file
echo WhisperJAV v1.7.4 Installer Build Log > "%BUILD_LOG%"
...
echo [Phase 4/6] Cleaning previous v1.7.4 builds...
echo [Phase 4/6] Cleaning previous builds... >> "%BUILD_LOG%"

REM Only clean v1.7.4 builds, preserve other versions
if exist build (
...
if errorlevel 1 (
    ...
    echo.
    echo Common issues:
    echo   - Missing dependencies in construct_v1.7.4.yaml
    ...
    echo   3. Verify all files in construct_v1.7.4.yaml extra_files exist
    echo.
    pause
    exit /b 1
)
...
echo   3. Check installation logs (install_log_v1.7.4.txt)
