...
QUICK START
-------------------------------------------------------------------------------
1. Double-click the "WhisperJAV v1.7.1" desktop icon
...
-------------------------------------------------------------------------------
Version 1.7.1 brings major improvements across 5 key areas:
...
For detailed release notes, see RELEASE_NOTES_v1.7.1.md
...
LAUNCHING THE APPLICATION:
  - Desktop shortcut: "WhisperJAV v1.7.1.lnk" (double-click to start)
...
LOGS AND DIAGNOSTICS:
  - Installation log: install_log_v1.7.1.txt (in install folder)
  - Application logs: Shown in GUI console during processing
  - Failure marker: INSTALLATION_FAILED_v1.7.1.txt (only if install failed)
...
SOURCE LANGUAGES (NEW in v1.7.1):
...
5. "Installation failed after retries":
   - Check install_log_v1.7.1.txt for specific error messages
...
4. "Subtitles have errors or gibberish":
   ...
   - Ensure correct source language is selected (NEW in v1.7.1)
...
6. "Translation interrupted and lost progress" (FIXED in v1.7.1):
   - v1.7.1 now auto-saves translation progress
...
NOTE: An automated uninstaller (uninstall_v1.7.1.bat) is included in the
...
TRANSLATION:
  ...
  # Resume interrupted translation (NEW in v1.7.1)
...
VERSION INFORMATION
-------------------------------------------------------------------------------
WhisperJAV Version: 1.7.1
Release Date: November 2025
Installer Version: v1.7.1 (conda-constructor)
...
For full release notes, see RELEASE_NOTES_v1.7.1.md
