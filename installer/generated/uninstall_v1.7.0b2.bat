@echo off
REM ===============================================================================
REM WhisperJAV v1.7.0b2 Uninstaller
REM ===============================================================================
REM
REM This script completely removes WhisperJAV v1.7.0b2 from your system:
...
echo ===============================================================================
echo                      WhisperJAV v1.7.0b2 Uninstaller
echo ===============================================================================
echo.
echo This will PERMANENTLY DELETE WhisperJAV v1.7.0b2 and all its files.
echo.
...
echo.
set /p CONFIRM="Are you sure you want to uninstall WhisperJAV v1.7.0b2? (yes/no): "
...
set UNINSTALL_LOG=%TEMP%\whisperjav_uninstall_v1.7.0b2.txt
echo WhisperJAV v1.7.0b2 Uninstallation Log > "%UNINSTALL_LOG%"
...
set SHORTCUT_PATH=%USERPROFILE%\Desktop\WhisperJAV v1.7.0b2.lnk
...
set CLEANUP_SCRIPT=%TEMP%\whisperjav_cleanup_v1.7.0b2.bat

echo @echo off > "%CLEANUP_SCRIPT%"
echo REM Temporary cleanup script for WhisperJAV v1.7.0b2 >> "%CLEANUP_SCRIPT%"
...
echo     echo. >> "%CLEANUP_SCRIPT%"
echo     echo WhisperJAV v1.7.0b2 has been uninstalled. >> "%CLEANUP_SCRIPT%"
...
echo   - Desktop shortcut: WhisperJAV v1.7.0b2.lnk
