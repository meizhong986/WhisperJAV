#!/usr/bin/env python
"""
WhisperJAV v1.5.3 Installer Validation Script
==============================================
...
# Required files for v1.5.3 installer
REQUIRED_FILES = [
    "construct_v1.5.3.yaml",
...
def validate_version_consistency():
    ...
    all_passed = True
    version_files = [
        ("construct_v1.5.3.yaml", r"version:\s*['\"]?(\d+\.\d+\.\d+)"),
        ("post_install_v1.5.3.py", r"WhisperJAV v(\d+\.\d+\.\d+)"),
        ("WhisperJAV_Launcher_v1.5.3.py", r"v(\d+\.\d+\.\d+)"),
        ("README_INSTALLER_v1.5.3.txt", r"WhisperJAV v(\d+\.\d+\.\d+)"),
    ]
...
def validate_requirements_encoding():
    ...
    filename = "requirements_v1.5.3.txt"
...
def validate_yaml_syntax():
    ...
    filename = "construct_v1.5.3.yaml"
...
def main():
    ...
    print()
    print("=" * 80)
    print(" " * 20 + "WhisperJAV v1.5.3 Installer Validation")
    print("=" * 80)
    print()
    ...
    if all_passed:
        ...
        print("Run: build_installer_v1.5.3.bat")
        print()
        return 0
    else:
        print()
