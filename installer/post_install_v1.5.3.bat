@echo off
REM ========================================
REM WhisperJAV v1.5.3 Post-Install Wrapper
REM ========================================
REM
...
ECHO ========================================
ECHO WhisperJAV v1.5.3 Post-Install
ECHO ========================================
ECHO.
...
if not exist "%~dp0..\post_install_v1.5.3.py" (
    ECHO ERROR: Cannot find post_install_v1.5.3.py
    ECHO Expected location: %~dp0..\post_install_v1.5.3.py
...
if %errorlevel% neq 0 (
    ...
    ECHO Check install_log_v1.5.3.txt for details
    ECHO.
    pause
    exit /b %errorlevel%
)
