@echo off
REM ===============================================================================
REM WhisperJAV v1.5.3 Uninstaller
REM ===============================================================================
REM
REM This script completely removes WhisperJAV v1.5.3 from your system:
...
echo ===============================================================================
echo                      WhisperJAV v1.5.3 Uninstaller
echo ===============================================================================
echo.
echo This will PERMANENTLY DELETE WhisperJAV v1.5.3 and all its files.
echo.
...
echo.
set /p CONFIRM="Are you sure you want to uninstall WhisperJAV v1.5.3? (yes/no): "
...
set UNINSTALL_LOG=%TEMP%\whisperjav_uninstall_v1.5.3.txt
echo WhisperJAV v1.5.3 Uninstallation Log > "%UNINSTALL_LOG%"
...
set SHORTCUT_PATH=%USERPROFILE%\Desktop\WhisperJAV v1.5.3.lnk
...
set CLEANUP_SCRIPT=%TEMP%\whisperjav_cleanup_v1.5.3.bat

echo @echo off > "%CLEANUP_SCRIPT%"
echo REM Temporary cleanup script for WhisperJAV v1.5.3 >> "%CLEANUP_SCRIPT%"
...
echo     echo. >> "%CLEANUP_SCRIPT%"
echo     echo WhisperJAV v1.5.3 has been uninstalled. >> "%CLEANUP_SCRIPT%"
...
echo   - Desktop shortcut: WhisperJAV v1.5.3.lnk
