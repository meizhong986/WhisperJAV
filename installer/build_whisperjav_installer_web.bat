...
REM
REM Output:
REM   dist/whisperjav-gui-web/whisperjav-gui-web.exe
...
if not exist "%~dp0whisperjav-gui-web.spec" (
    echo ERROR: Spec file not found!
    echo Expected: %~dp0whisperjav-gui-web.spec
    echo.
    pause
    exit /b 1
)
...
if exist "%~dp0dist\whisperjav-gui-web" rmdir /s /q "%~dp0dist\whisperjav-gui-web"
...
pyinstaller "%~dp0whisperjav-gui-web.spec" --clean --noconfirm
...
echo   %~dp0dist\whisperjav-gui-web\whisperjav-gui-web.exe
echo.
echo To test the executable:
echo   cd "%~dp0dist\whisperjav-gui-web"
echo   whisperjav-gui-web.exe
echo.
echo Distribution folder contents:
dir /b "%~dp0dist\whisperjav-gui-web"
echo.
pause
