...
QUICK START
-------------------------------------------------------------------------------
1. Double-click the "WhisperJAV v1.5.3" desktop icon
...
-------------------------------------------------------------------------------
Version 1.5.3 brings major improvements across 5 key areas:
...
For detailed release notes, see RELEASE_NOTES_v1.5.3.md
...
LAUNCHING THE APPLICATION:
  - Desktop shortcut: "WhisperJAV v1.5.3.lnk" (double-click to start)
...
LOGS AND DIAGNOSTICS:
  - Installation log: install_log_v1.5.3.txt (in install folder)
  - Application logs: Shown in GUI console during processing
  - Failure marker: INSTALLATION_FAILED_v1.5.3.txt (only if install failed)
...
SOURCE LANGUAGES (NEW in v1.5.3):
...
5. "Installation failed after retries":
   - Check install_log_v1.5.3.txt for specific error messages
...
4. "Subtitles have errors or gibberish":
   ...
   - Ensure correct source language is selected (NEW in v1.5.3)
...
6. "Translation interrupted and lost progress" (FIXED in v1.5.3):
   - v1.5.3 now auto-saves translation progress
...
NOTE: An automated uninstaller (uninstall_v1.5.3.bat) is included in the
...
TRANSLATION:
  ...
  # Resume interrupted translation (NEW in v1.5.3)
...
VERSION INFORMATION
-------------------------------------------------------------------------------
WhisperJAV Version: 1.5.3
Release Date: November 2025
Installer Version: v1.5.3 (conda-constructor)

Key Changes in 1.5.3:
...
For full release notes, see RELEASE_NOTES_v1.5.3.md
